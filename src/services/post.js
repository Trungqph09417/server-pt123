...
import genarateDate from "../utils/genarateDate";
      ...
      const response = await db.Post.findAll({
        ...
        include: [
          { model: db.Image, as: "images", attributes: ["image"] },
          {
            model: db.Attribute,
            as: "attributes",
            attributes: ["price", "hashtag", "acreage", "published"],
          },
          {
            model: db.User,
            as: "user",
...
export const getPostPaginatesService = (
  page,
  ...
  new Promise(async (resolve, reject) => {
    try {
      ...
      await db.Overview.create({
        ...
        expired: currentDate.exprireDay,
      });
...
export const getPostPaginatesManage = (page, id, query) =>
  new Promise(async (resolve, reject) => {
    try {
      let offset = !page || +page <= 1 ? 0 : +page - 1;
...
export const deletePost = (postId) =>
  new Promise(async (resolve, reject) => {
    try {
      ...
      resolve({
        err: response > 0 ? 0 : 1,
        msg: response > 0 ? "Delete" : "No delete ",
      });
    } catch (e) {
      reject(e);
    }
